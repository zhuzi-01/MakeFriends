  ...
  <div class="container">
   ...
   <div class="services">
	   ...
	   <form action="<%=basePath %>upload" method="post" enctype="multipart/form-data">
	      ...
	      <label for="edit-name">选择文件 <span class="form-required" title="This field is required.">*</span></label><br/><br/>
	      <input type="file"  name="file" >
	    </div>
	    <div class="form-actions">
	    	<input type="submit" id="edit-submit" value="上传" class="btn_1 submit">
	    </div>
	   </form>
	  </div>
	  <div class="col-sm-6">
