...
<%Member member=(Member)session.getAttribute("user"); %>
<h3>欢迎您：<%=member.getLogname()%></h3><br>
<h4><a href="<%=basePath %>view/index.jsp">三秒后跳转首页如果没有跳转，那我也没办法!!!</a></h4>
<div id="img"><img alt="" src="<%=basePath %>static/images/s3.jpg"></div>
</div>
<div class="footer">
    	<div class="container">
