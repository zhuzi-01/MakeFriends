...
<div class="grid_3">
  <div class="container">
   ...
   <div class="services">
	   ...
	   <form action="<%=basePath%>updatePwdController" method="get">
  	    <div class="form-item form-type-textfield form-item-name">
	      <label for="edit-name">OldPassword <span class="form-required" title="This field is required.">*</span></label>	     
	      <input type="text"  id="edit-name" name="oldpwd" value="" size="60" maxlength="60" class="form-text required">
	    </div>
	    <div class="form-item form-type-password form-item-pass">
	      <label for="edit-pass">NewPassword <span class="form-required" title="This field is required.">*</span></label>
	      &emsp;<label id="pa" style="color: red;"></label>
	      <input type="password" onblur="checkpa()" id="edit-pass" name="newpwd" size="60" maxlength="128" class="form-text required">
	    </div>
