...
<div class="grid_3">
  <div class="container">
   ...
   <div class="services">
	     ...
	     <form action="<%=basePath %>updateAllController" method="get">
		      ...
		      <input type="text" onblur="checkph()" id="edit-phone" name="phone" value="" size="60" maxlength="60" class="form-text required">
		    </div>
		    <div class="form-group">
		      <label for="edit-name">Email <span class="form-required" title="This field is required.">*</span></label>
		     &emsp;<label id="em" style="color: red;"></label>
		      <input type="text" onblur="checkem()" id="edit-email" name="email" value="" size="60" maxlength="60" class="form-text required">
		    </div>
		    <div class="form-group">
		      <label for="edit-name">message <span class="form-required" title="This field is required.">*</span></label>
		      &emsp;<label id="me" style="color: red;"></label>
		      <textarea maxlength="60" onblur="checkme()" id="edit-mess"  name="message"  rows="10" class="form-textarea"  style="height: 120px"></textarea>
		    </div>
            
                 
			  <div class="form-actions">
			    <input type="submit" id="edit-submit" name="op" value="Submit" class="btn_1 submit">&emsp;&emsp;
			    <input type="reset" id="edit-submit" name="op" value="Reset" class="btn_1 submit">
			  </div>
		 </form>
	  </div>
	  <div class="col-sm-6">
...
function out() {
 ...
 <script type="text/javascript">
		    function checkme(){
				var val=document.getElementById("edit-mess").value;
				if (val.length==0) {
					document.getElementById("me").innerHTML="描述信息不能为空";
				}
				else{
